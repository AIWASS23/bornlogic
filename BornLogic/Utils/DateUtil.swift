...
class DateUtil {
    ...
    static func convert(input: String, inputFormat: AppDateFormat, outputFormat: AppDateFormat, timeZone: TimeZone = TimeZone.current) -> String? {
    ...
    static func convert(input: Date, outputFormat: AppDateFormat, timeZone: TimeZone = TimeZone.current) -> String? {
        DateUtil.formatter.dateFormat = outputFormat.rawValue

        var result: String?
        DateUtil.formatter.timeZone = timeZone
        result = DateUtil.formatter.string(from: input)
